  ...
  protected static Map<String, Integer> resources = new HashMap<String, Integer>() {
    {
      ...
      put("37n", R.drawable.arrow_up_s);
      put("37e", R.drawable.arrow_up_w);
      put("37w", R.drawable.arrow_up_e);
      put("37s", R.drawable.arrow_up_n);

      put("39", R.drawable.arrow_left);
      put("39n", R.drawable.arrow_up_e);
      put("39e", R.drawable.arrow_up_s);
      put("39w", R.drawable.arrow_up_n);
      put("39s", R.drawable.arrow_up_w);

      put("38", R.drawable.arrow_right);
      put("38n", R.drawable.arrow_up_w);
      put("38e", R.drawable.arrow_up_n);
      put("38s", R.drawable.arrow_up_e);
      put("38w", R.drawable.arrow_up_s);

      put("40", R.drawable.newcircle);
      put("40n", R.drawable.circle_n);
      put("40s", R.drawable.circle_s);
